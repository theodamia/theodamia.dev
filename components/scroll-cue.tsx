...
export function ScrollCue({ gone, onStart }: ScrollCueProps) {
  return (
    <button
      ...
      className={cn(
        'border-line shadow-soft text-ink hover:border-ink bg-card timeline:hidden ease-soft fixed bottom-[114px] left-1/2 z-[80] inline-flex min-h-11 -translate-x-1/2 cursor-pointer items-center gap-[9px] rounded-full border px-5 text-[15.5px] font-semibold whitespace-nowrap transition-[opacity,translate,border-color] duration-[350ms] motion-reduce:transition-none',
